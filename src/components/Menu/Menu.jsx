...
const Menu = ({ onLatitudeChange, onLongitudeChange, onDarkModeChange, onUsaModeChange, darkMode, usaMode }) => {
			...
			<div className={`${containerStyle} ${isOpen ? styles.open : styles.closed}`}>
				<div className={styles.division}>
					...
					<div className={styles.menuSpace}>
						<Search darkMode={darkMode} onLatitudeChange={onLatitudeChange} onLongitudeChange={onLongitudeChange} />
					</div>
